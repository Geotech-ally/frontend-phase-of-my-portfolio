...
|------|-----------|---|
| `index.html` | ~150 | Navigation underline, service card glow, counter pulse |
...
index.html, about.html, services.html, contact.html, projects.html, blogs.html
...
### HTML Files
- [x] index.html (728 lines, +150 CSS)
